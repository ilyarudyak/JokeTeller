 ...
 * on 2015-09-30 at 13:49:14 UTC 
 * Modify at your own risk.
 */

package com.ilyarudyak.joketeller.jokeapi.jokeApi;
...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://joketeller-1052.appspot.com/_ah/api/";
  ...
  public class GetJoke extends JokeApiRequest<com.ilyarudyak.joketeller.jokeapi.jokeApi.model.Joke> {
    ...
    protected GetJoke(java.lang.Long id) {
      super(JokeApi.this, "GET", REST_PATH, null, com.ilyarudyak.joketeller.jokeapi.jokeApi.model.Joke.class);
   ...
   *
   * @param content the {@link com.ilyarudyak.joketeller.jokeapi.jokeApi.model.Joke}
   * @return the request
   */
  public InsertJoke insertJoke(com.ilyarudyak.joketeller.jokeapi.jokeApi.model.Joke content) throws java.io.IOException {
    InsertJoke result = new InsertJoke(content);
    initialize(result);
    return result;
  }

  public class InsertJoke extends JokeApiRequest<com.ilyarudyak.joketeller.jokeapi.jokeApi.model.Joke> {
     ...
     * @since 1.13
     */
    protected InsertJoke(com.ilyarudyak.joketeller.jokeapi.jokeApi.model.Joke content) {
      super(JokeApi.this, "POST", REST_PATH, content, com.ilyarudyak.joketeller.jokeapi.jokeApi.model.Joke.class);
    }
