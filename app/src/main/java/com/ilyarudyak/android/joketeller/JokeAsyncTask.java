...
public class JokeAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    private JokeApi.Builder mBuilder;
...
//            setCloudBuilder();
        ...
        try {
            if (mJokeApiService.getJoke(1L).execute() != null) {
...
//        Toast.makeText(mContext, jokeStr, Toast.LENGTH_LONG).show();
    ...
    // helper methods
    private void setLocalBuilder() {
                    mBuilder = new JokeApi.Builder(AndroidHttp.newCompatibleTransport(),
    ...
    private void setCloudBuilder() {
        mBuilder = new JokeApi.Builder(AndroidHttp.newCompatibleTransport(), new AndroidJsonFactory(), null)
